defmodule CtbcWeb.EventLiveTest do
  use CtbcWeb.ConnCase

  import Phoenix.LiveViewTest
  import Ctbc.EventsFixtures

  @create_attrs %{name: "some name", status: "some status", type: "some type", description: "some description", image: "some image", date_of_event: "some date_of_event", time_of_starting: "some time_of_starting", time_of_ending: "some time_of_ending", price: "some price", venue: "some venue"}
